...
export function Schedule({ locale = "en" }: ScheduleProps) {
  ...
  return (
    <section id="termini" className="section section--schedule" aria-labelledby="termini-title">
      <div className="section__inner section--schedule__inner">
        ...
        <h2 id="termini-title" className="section__heading section__heading--xl js-section-title">
        ...
        <div className="schedule__grid">
          <article className="schedule__card js-schedule-card">
            ...
            <span className="schedule__card-time">19:00</span>
          ...
          <article className="schedule__card js-schedule-card">
            ...
            <span className="schedule__card-time">08:00</span>
